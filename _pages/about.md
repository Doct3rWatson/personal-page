...
Dr. Courtney B. Watson currently works as a postdoctoral scholar at the Harvard & Smithsonian | Center for Astrophysics with Dr. Kim-Vy Tran as the project and data manager for the AGEL Survey.  In this role I have built the framework for the AGEL survey workflows and policies for handling AGEL data. In addition, I established the permanent AGEL data archive to house all the data from the survey as well as individual researchers. See my projects page for more info. 
